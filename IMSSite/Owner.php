...
<head>
    <title class="tit">Welcome to Owner Page</title>
...
<body id="tableContainer">
    <nav class="navbar">
        <div class="container">
            <a class="logo" href="Owner.html">Stock Management</a>
            <ul class="nav-links">
    ...
    <div>
        <input type="search" id="search" placeholder="Type your search" />
        <select id="select">
            <option hidden selected>Filter by</option>
            ...
            if (isset($_POST['selectedOption']) && isset($_POST['text'])) {
                $selectedOption = $_POST['selectedOption'];
                $text = $_POST['text'];
                if ($selectedOption == "Employee-Name") {
                    $sql = " SELECT * FROM transaction  WHERE ename='$text' order by quantity;";
                    $err = "Type the correct Employee name.";
                } else if ($selectedOption == "Product-Name") {
                    $sql = " SELECT * FROM transaction WHERE pname='$text' order by quantity ;";
            ...
            <tbody>";
                ...
                echo "<h1 class=man>Welcome Manager</h1>";
            }
