...
<nav class="navbar">
    ...
    <div class="container">
      ...
      <table id="productTable"> 
        ...
        <?php
    function notify($to, $title,$body,$image)
                {
                    $data = array(
                        'title' => $title,
                        'body' => $body,
                ...
                if (isset($_POST['send_notification'])) {
                    $to = "dIDH_kDiQCKanvIhY8ujoa:APA91bE--BwmDZGSs3qPNtA09mnGiL4wf1GPq57sZmBC2TzkXzdGkiX3he3rVCLnvD8TNd-DGO6FxDTnq2_9BMQST8_A0A3xq0K6tYLexCKvzmdDWCIICL99qygsxqV49XpSE_G0wwt0";
                    $title = "greeting";
       ...
       Go to Retrieval Page</button></form></div>
    </div>
    <div class="footers">
      <footer class="footer">
            <div class="top">
