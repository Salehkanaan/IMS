...
<body>
    ...
    <div class="bord">
        ...
        <form id="myForm" class="form" action="saving.php" method="post">
            <input type="text" class="txt" placeholder="Type the product name" id="product_name" name="product_name" required><br /><br />

            <input type="number" placeholder="Type the quantity desired" class="txt" id="quantity" name="quantity" min="1" required><br />

            <input type="hidden" id="date_time" name="date_time" value="<?php echo date('Y-m-d H:i:s'); ?>"><br />
